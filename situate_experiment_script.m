...
% results, and how many images for training and testing.
    ...
    experiment_settings.results_directory = '/stash/mm-group/evan/sample_folder';
    % results directory
...
% settings popup, the rest will be ignored.
    ...
    description = 'box adjust no leash';
    temp = p;
