...
% basic setup
    ...
    use_existing_training_testing_split_files = true;
...
%     results_directory = fullfile('/Users/',char(java.lang.System.getProperty('user.name')),'/Desktop/', [experiment_title '_' datestr(now,'yyyy.mm.dd.HH.MM.SS')]);
    ...
    num_folds = 1;
    testing_data_max  = 10;   % empty will use as much as possible given the folds.
    training_data_max = 400; % empty will use as much as possible given the folds. 
...
%   each of the conditions specified later
    ...
    % check-in and tweaking
        ...
        p.internal_support_threshold = .15; % scout -> reviewer threshold
        p.total_support_threshold_1  = .15; % workspace provisional check-in threshold (search continues)
...
%         learned_stuff.box_adjust_models = load('/stash/mm-group/evan/saved_models_box_adjust/combo400.mat');
%         
%         end
...
%                                 learned_stuff.box_adjust_models{1}
                                learned_stuff.box_adjust_models.alignments_in_indexing_order = {'centered','up','down','right','left','contract','expand','background'};
