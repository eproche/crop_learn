...
% make crop directories: rewrites at each call
    ...
    here = pwd;
    cd '/stash/mm-group/evan/crop_learn/data/fullset2/'
    rmdir(split_type,'s');
    mkdir(split_type);
    cd (split_type);
    ...
    for i = 1:len_list
        ...
        label_name = strrep(label_list(i),'.jpg','.labl');
        temp = fopen(fullfile(Path,label_name{1}));
...
%%
    for i = 1:len_list%cropping
        ...
        if strcmp(split_type,'train') == 1
            folder = '/stash/mm-group/evan/crop_learn/data/fullset2/train/';
        elseif strcmp(split_type,'test') == 1
            folder = '/stash/mm-group/evan/crop_learn/data/fullset2/test/';
        end
