...
for ii = 1:3
	down = image_files(strcat('/stash/mm-group/evan/crop_learn/data/fullset2/train/',path_var{ii},'/down/'));
	up = image_files(strcat('/stash/mm-group/evan/crop_learn/data/fullset2/train/',path_var{ii},'/up/'));
	left = image_files(strcat('/stash/mm-group/evan/crop_learn/data/fullset2/train/',path_var{ii},'/left/'));
	right = image_files(strcat('/stash/mm-group/evan/crop_learn/data/fullset2/train/',path_var{ii},'/right/'));
	shrink = image_files(strcat('/stash/mm-group/evan/crop_learn/data/fullset2/train/',path_var{ii},'/shrink/'));
	expand = image_files(strcat('/stash/mm-group/evan/crop_learn/data/fullset2/train/',path_var{ii},'/expand/'));
	orig = image_files(strcat('/stash/mm-group/evan/crop_learn/data/fullset2/train/',path_var{ii},'/orig/'));
	back = image_files(strcat('/stash/mm-group/evan/crop_learn/data/fullset2/train/',path_var{ii},'/background/'));
	%%	
	...
	save(model_var(ii),'svm_model','file_list')
end