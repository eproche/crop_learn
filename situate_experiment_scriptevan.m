...
% check a little that sub directories are included
    clearvars -except learned_stuff
    rng('shuffle')
...
%% define experiment settings
    ...
    experiment_settings.results_directory = '/u/eroche/box_cnn_results/';
...
%% define situate parameters: shared
    ...
    % check-in and tweaking
        ...
        p.thresholds.internal_support = .4; % scout -> reviewer threshold
        p.thresholds.total_support_provisional = .4; %(search continues)
