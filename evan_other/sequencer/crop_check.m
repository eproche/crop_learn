...
% save('/stash/mm-group/evan/matlab/base_image.mat','base_image');
disp(object_class)
% save('/stash/mm-group/evan/matlab/ground_truth.mat','label');
disp(starting_box)
disp(starting_IOU)
...
%     global net layer;
%     here = pwd;
%     cd '/stash/mm-group/evan/matlab/cnn/matconvnet-1.0-beta20/';
